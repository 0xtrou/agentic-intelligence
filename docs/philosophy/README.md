...
Debates and agreements that shape how we build. These aren't abstract — they directly influence architecture, priorities, and what we ship.

## Index

| # | Title | Date | Status |
|---|-------|------|--------|
| 001 | [Intelligence vs Machine](./001-intelligence-vs-machine.md) | 2026-03-11 | Agreed |
| 002 | [Where Is the Edge?](./002-where-is-the-edge.md) | 2026-03-10 | Agreed — funding rate first, backtest before deploy |
